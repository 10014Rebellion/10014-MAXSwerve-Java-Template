...
public class commandDrivetrainAlignToTarget extends Command{
    ...
    public commandDrivetrainAlignToTarget(DriveSubsystem robotDrive, CommandXboxController driverController, Supplier<Pose2d> robotPose, Supplier<Double> targetYaw) {
