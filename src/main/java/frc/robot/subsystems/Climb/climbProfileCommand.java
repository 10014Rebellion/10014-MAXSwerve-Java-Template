...
public class climbProfileCommand extends ProfiledPIDCommand {
  /** Creates a new climbProfileCommand. */
  public climbProfileCommand(climbPIDSubsystem climbSubsystem, double climbGoal, boolean isRightClimb) {
    super(
